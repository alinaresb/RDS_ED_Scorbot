...
from from trajectory_msgs.msg import *


if __name__ == '__main__':
    try:
        rospy.init_node('joint_control', anonymous=True)
        client = actionlib.SimpleActionClient('/scorbot/trajectory_controller/follow_joint_trajectory', JointTrajectoryAction)
        client.wait_for_server()

        goal = trajectory_msgs.msg.JointTrajectoryGoal()
        goal.trajectory.joint_names.append("base")
        goal.trajectory.joint_names.append("elbow")
        goal.trajectory.joint_names.append("gripper_finger_left_joint")
        goal.trajectory.joint_names.append("gripper_finger_right_joint")
        ...
        point2.positions = [1.5, 1.0, 0.5,  1.0, 1.5, 1.0, 1.0]
